...
from library import DialogWindow, ErrorDialog



class Ui_MainWindow(DialogWindow):
    def __init__(self):
        ...
        self.minimize_button.setGeometry(QRect(228, 4, 16, 16))
        ...
        self.volume_text_box.setToolTip("<p>Enter volume change in dB (integer). Can be negative. E.g. '5 or -3'</p>")
        ...
        self.audio_ratio_text_box.setToolTip("<p>Enter ratio to attenuate (While added audio is talking, the movie track will temporarily drown out) E.g. 2.5 (Range: 1 - 9.99)</p>")
    ...
    def start_editor(self):
        self.editor = Editor(self.output_text_box.text(), self.video_text_box.text(), self.audio_text_box.text())
